...
{
    public sealed partial class ToastHistoryChangeTrackerPage : Page
    {
        private ToastContent _toastContent;

        public ToastHistoryChangeTrackerPage()
        {
            InitializeComponent();
            Initialize();
        }
        ...
        private ToastHistoryChangeReader _reader;

        private async void ButtonReadChanges_Click(object sender, RoutedEventArgs e)
        {
            if (_reader == null)
            {
                await ToastHistoryChangeTracker.Current.EnableAsync();
                _reader = ToastHistoryChangeTracker.Current.GetChangeReader();
            }
        }
